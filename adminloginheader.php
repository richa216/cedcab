  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="admincancelrides.php">Canceled Rides</a></li>
            <li><a href="showallrides.php">All Rides</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="pendingrides.php">Pending User Requests</a></li>
            <li><a href="approveuserreq.php">Approved User Requests</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li id="activeUsename" ><a href="#" style="color:white;"><span class="glyphicon glyphicon-user"></span><?php echo $v; ?></a></li>
